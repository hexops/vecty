...
func Command(markup ...vecty.Markup) *vecty.Element {
	e := &vecty.Element{TagName: "command"}
	vecty.List(markup).Apply(e)
	return e
}
...
func Content(markup ...vecty.Markup) *vecty.Element {
	e := &vecty.Element{TagName: "content"}
	vecty.List(markup).Apply(e)
	return e
}
...
func KeyGeneration(markup ...vecty.Markup) *vecty.Element {
	e := &vecty.Element{TagName: "keygen"}
	vecty.List(markup).Apply(e)
	return e
}
