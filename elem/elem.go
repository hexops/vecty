...
func Blink(aspects ...dom.Aspect) dom.Aspect {
	return dom.Element("blink", aspects...)
}
...
func Decorator(aspects ...dom.Aspect) dom.Aspect {
	return dom.Element("decorator", aspects...)
}
...
func Spacer(aspects ...dom.Aspect) dom.Aspect {
	return dom.Element("spacer", aspects...)
}
